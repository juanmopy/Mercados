...
export async function generateDeliveryPDF(deliveries: DeliveryForPDF[]): Promise<Uint8Array> {
  ...
  // Grid positions (x, yBottom for photo)
  const positions = [
    { x: MARGIN, y: PAGE_H - MARGIN - PHOTO_H },           // top-left
    { x: MARGIN + PHOTO_W + 30, y: PAGE_H - MARGIN - PHOTO_H }, // top-right
    { x: MARGIN, y: PAGE_H - MARGIN - PHOTO_H * 2 - 80 },  // bottom-left
    { x: MARGIN + PHOTO_W + 30, y: PAGE_H - MARGIN - PHOTO_H * 2 - 80 }, // bottom-right
  ];
